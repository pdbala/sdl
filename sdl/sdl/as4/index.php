...
<div class="container bg-white d-flex justify-content-center flex-column mw-400 my-3">
    ...
    <div class="dropdown my-2">
        ...
        <ul class="dropdown-menu">
            <li class="dropdown-item"><button class="btn btn-info" type="submit" name="sbycap">Capital</button></li>
            <li class="dropdown-item"> <button class="btn btn-info" type="submit" name="sbycon">Country name</button></li>
        </ul>
    </div>
...
<?php
$countries = array("India" => "New Delhi", "Italy" => "Rome", "Luxembourg" => "Luxembourg", "Belgium" => "Brussels", "Denmark" => "Copenhagen", "Finland" => "Helsinki", "France" => "Paris", "Slovakia" => "Bratislava", "Slovenia" => "Ljubljana", "Germany" => "Berlin", "Greece" => "Athens", "Ireland" => "Dublin", "Netherlands" => "Amsterdam", "Portugal" => "Lisbon", "Spain" => "Madrid", "Sweden" => "Stockholm", "United Kingdom" => "London", "Cyprus" => "Nicosia", "Lithuania" => "Vilnius", "Czech Republic" => "Prague", "Estonia" => "Tallin", "Hungary" => "Budapest", "Latvia" => "Riga", "Malta" => "Valetta", "Austria" => "Vienna", "Poland" => "Warsaw");
